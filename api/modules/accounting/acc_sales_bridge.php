...
require_once __DIR__ . '/../sales/sales_bridge_read_model.php';
...
// Sales-owned read model (no direct orders SQL in accounting module).
$orders = app_sales_bridge_fetch_orders_for_accounting($pdo, $mode, $orderId, $dateFrom, $dateTo, 2000);
