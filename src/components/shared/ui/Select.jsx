...
export const Select = forwardRef(({
  ...
  <select
    ...
    className={cn(
      'focus-ring w-full rounded-[var(--radius-md)] border bg-white font-bold text-[rgb(var(--ui-text))] shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] transition duration-[var(--motion-fast)]',
      invalid
