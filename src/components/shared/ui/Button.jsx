...
const VARIANT_CLASSNAMES = {
  ...
  destructive: 'border-transparent bg-red-600 text-white shadow-[var(--shadow-soft)] hover:-translate-y-px hover:bg-red-700',
  ...
  danger: 'border-transparent bg-red-600 text-white shadow-[var(--shadow-soft)] hover:-translate-y-px hover:bg-red-700',
