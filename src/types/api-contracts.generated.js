...
/**
 * @typedef { glasses: Array<Record<string, any>>, thicknesses?: Array<number>, operations: Array<Record<string, any>>, connectors: Record<string, any>, fees: Record<string, any>, factoryLimits?: { maxShortSideCm?: number, maxLongSideCm?: number, minimumChargeEnabled?: boolean, minimumChargeThresholdM2?: number, minimumBillableAreaM2?: number }, jumboRulesEnabled?: boolean, jumboRules?: Array<{ id: string, title?: string, shortSideOverCm?: number, longSideOverCm?: number, adjustmentType?: "percentage" | "fixed", adjustmentValue?: number, sortOrder?: number }>, roundStep?: number } CatalogSaveRequest
 */
