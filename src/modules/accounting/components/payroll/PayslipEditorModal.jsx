...
export function PayslipEditorModal({
  busy,
  catalog = [],
  employees = [],
  onClose,
            ...
            <PayrollSurface className="space-y-2">
              ...
              <label className="space-y-1">
                ...
                <datalist id="payslip-editor-employees">
                  {employeeList.map((employee) => <option key={String(employee.id)} value={formatEmployeeOption(employee)} />)}
                </datalist>
          ...
          <table className="w-full text-right text-xs">
            <thead className="bg-slate-50 text-[11px] font-black text-slate-500">
              <tr>
                ...
                <th className="w-44 px-3 py-2">مقدار</th>
              </tr>
            </thead>
