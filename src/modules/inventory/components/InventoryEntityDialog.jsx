...
export const InventoryEntityDialog = ({
  ...
  <ModalShell
    ...
    headerClassName="!border-white/10 !bg-[linear-gradient(180deg,rgba(15,23,42,0.98),rgba(2,6,23,0.98))] [&_h3]:!text-white [&_p]:!text-white/75 [&_button]:!text-white [&_button]:hover:!bg-white/10"
    bodyClassName="space-y-4 rounded-b-[32px] bg-[linear-gradient(180deg,rgba(247,247,248,0.88),rgba(243,243,245,0.96))] p-4 sm:p-5 [&_label]:text-[12px] [&_label]:font-black [&_label]:text-slate-600 [&_input]:h-11 [&_input]:rounded-2xl [&_input]:border-slate-200 [&_input]:bg-white/90 [&_input]:px-3 [&_input]:text-sm [&_select]:h-11 [&_select]:rounded-2xl [&_select]:border [&_select]:border-slate-200 [&_select]:bg-white/90 [&_select]:px-3 [&_select]:text-sm"
