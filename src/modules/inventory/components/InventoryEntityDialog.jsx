...
export const InventoryEntityDialog = ({
  ...
  <ModalShell
    ...
    headerClassName="rounded-t-[32px] !border-white/10 !bg-[linear-gradient(180deg,rgba(15,23,42,0.98),rgba(2,6,23,0.98))] [&_h3]:!text-white [&_p]:!text-white/75 [&_button]:!text-white [&_button]:hover:!bg-white/10"
