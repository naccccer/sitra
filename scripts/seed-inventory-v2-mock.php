...
$fixturePath = __DIR__ . '/../database/fixtures/inventory_v2_mock_fixture.sql';
...
try {
    ...
    $pdo->commit();
    fwrite(STDOUT, "Inventory V2 mock fixture applied successfully.\n");
    exit(0);
} catch (Throwable $e) {
    if ($pdo->inTransaction()) {
        $pdo->rollBack();
    }
    fwrite(STDERR, "Failed to apply Inventory V2 fixture: {$e->getMessage()}\n");
    exit(1);
}
