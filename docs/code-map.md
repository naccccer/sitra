...
| Inventory Operations | `src/modules/inventory` | `api/modules/inventory` | `inventory_warehouses`, `inventory_items`, `inventory_stock`, `inventory_documents`, `inventory_document_lines`, `inventory_requests`, `inventory_count_sessions`, `inventory_count_lines` | `GET /api/inventory_warehouses.php`, `GET|POST|PUT|PATCH /api/inventory_items.php`, `GET|POST|PATCH /api/inventory_documents.php`, `GET|POST|PATCH /api/inventory_requests.php`, `GET|POST|PATCH /api/inventory_counts.php`, `GET /api/inventory_reports.php` |
